# Operator Quickstart — Wholesale of solid, liquid and gaseous fuels

Shortest path from clone to a verified local dry-run for **ISIC 4671** (`cloud-itonami-isic-4671`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4671.git
cd cloud-itonami-isic-4671
```
...
- Blueprint governor key: `fuel-trading-governor`
- Likely source path: `fueltrade.governor.cljc`
